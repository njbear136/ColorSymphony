    ...
    <div className="canvas-container"> 
      ...
      <div className="controls"> 
        ...
        <div> 
          ...
          min="1"
           max="30" 
           value={lineWidth} onChange={(e) => setLineWidth(e.target.value)} /> 
        </div> 
        ...
        <div> 
          ...
          min="5" 
          max="50" 
          value={eraserSize} onChange={(e) => setEraserSize(e.target.value)} /> 
          <button onClick={() => setUsingEraser(!usingEraser)} 
          style={{ backgroundColor: usingEraser ? "#fcbad3" : "#a7d8ff", 
          borderRadius: "10px", 
          padding: "8px 16px", 
          cursor: "pointer", 
          color: "#333",
      ...
      <div className="buttons"> 
        ...
        <button onClick={() => { 
          ...
          link.click(); 
        }} className="save-btn" > Save Drawing </button> 
      </div> 
    </div> 
  ); 
}
